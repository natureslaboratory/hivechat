...
/***/ "./js/src/classes/OrganisationMember.ts":
/*!**********************************************!*\
  !*** ./js/src/classes/OrganisationMember.ts ***!
  \**********************************************/
...
var OrganisationMember = /** @class */ (function () {
    function OrganisationMember(node) {
        ...
        this.memberID = Utils_1.default.getPerchElement(this.node, "memberID", "form-control");
    ...
    OrganisationMember.prototype.addEventListeners = function () {
        var _this = this;
        ...
        this.email.addEventListener("change", function () {
            _this.clearMessage();
            if (_this.email.value) {
                _this.checkUserExists();
            }
    ...
    OrganisationMember.prototype.checkUserExists = function () {
        var _this = this;
        clearTimeout(this.timeout);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.checkUserNotInOrg()];
                        case 1:
                            isOrgMember = _a.sent();
                            if (!isOrgMember) {
                                this.enableButton();
    ...
    OrganisationMember.prototype.checkUserNotInOrg = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, isOrgMember];
                }
            });
        });
    };
    OrganisationMember.prototype.enableButton = function () {
        this.button.disabled = false;
    };
    OrganisationMember.prototype.disableButton = function () {
        this.button.disabled = true;
    };
    OrganisationMember.prototype.setMessage = function (message) {
        this.messageElement.innerHTML = message;
    };
    OrganisationMember.prototype.clearMessage = function () {
        this.messageElement.innerHTML = "";
    };
    return OrganisationMember;
}());
exports.default = OrganisationMember;


/***/ }),

/***/ "./js/src/classes/Utils.ts":
/*!*********************************!*\
  !*** ./js/src/classes/Utils.ts ***!
  \*********************************/
...
var Utils = /** @class */ (function () {
    ...
    Utils.getPerchElement = function (node, id, className) {
        var array = node.getElementsByClassName(className);
        if (array) {
            return Array.from(array).filter(function (el) { return el.id.includes(id); })[0];
        }
        return null;
...
var addOrgMemberForm = Utils_1.default.getPerchElement(document.body, "add_organisation_member", "form");
if (addOrgMemberForm) {
    new OrganisationMember_1.default(addOrgMemberForm);
}
